...
public class homeController {
	...
	public String home(Model model) throws Exception {
		...
		String chart = "";
		for (int i = 0; i < numAttemWithRowNum.size(); i++) {

			chart += "<tr><td />" + numAttemWithRowNum.get(i).getRowNum() + "</td>\r\n" + "<td style='width: 200px;' />"
					+ numAttemWithRowNum.get(i).getMethod() + "</td>\r\n" + "<td style='width: 200px;' />"
					+ numAttemWithRowNum.get(i).getNumAttem() + "</td></tr>";
		}

		model.addAttribute("numAttemWithRowNum", chart);
